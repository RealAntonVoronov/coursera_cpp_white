...
std::string PrintAnswer(const std::string& first_name, const std::string& last_name){
...
std::string PrintAnswerWithHistory(const std::vector<std::string>& all_names,
                                   const std::vector<std::string>& all_surnames){
